...
const accountablitySilpRepository_1 = require("../accountabilitySlip/accountablitySilpRepository");
const eventRepository_1 = require("../event/eventRepository");
const uploadImageS3_1 = __importDefault(require("../../../../../utils/v1/s3/image/uploadImageS3"));
...
const accountablityRepository = new accountablitySilpRepository_1.AccountablityRepository();
const eventRepository = new eventRepository_1.EventRepository();
const userRepository = new userRepository_1.UserRepository();
const profileService = new profileService_1.ProfileService(profileRepository, chapterRepository, userRepository, accountablityRepository, eventRepository);
...
profileRouter.get("/home", authenticate_1.authenticate, (req, res, next) => controller.getHomeProfile(req, res, next));
profileRouter.get("/home/weekly-report", authenticate_1.authenticate, (req, res, next) => controller.weeklyReport(req, res, next));
profileRouter.get("/", authenticate_1.authenticate, (req, res, next) => controller.getProfile(req, res, next));
profileRouter.patch("/profile-picture", uploadImageS3_1.default.fields([{ name: "image" }]), authenticate_1.authenticate, (req, res, next) => controller.updateProfilePicture(req, res, next));
